...
public class VectorMain
{
	...
	public static void printData(String owner, String password, VectorSecureDataContainer<?> container)
	{
		if(owner == null)
		{
	...
	public static void test1()
	{
		...
		VectorSecureDataContainer<Integer> container = new VectorSecureDataContainer<Integer>();
		try
		{
